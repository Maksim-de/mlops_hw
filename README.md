...
Этот проект является частью курса MLOps и демонстрирует полный цикл разработки
ML-решения: от исследования данных до развертывания модели с использованием
современных MLOps практик.
